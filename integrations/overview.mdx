...
|---|---|
| **Instagram** | Read connected profile context, fetch insights, pull comments for review, and prepare campaign-ready copy |
| **YouTube** | Read channel data, fetch video stats, pull comment context, and support campaign analysis |
| **Google Drive** | Find files and folders, pull campaign assets, and attach Drive links to briefs or tasks |
| **ClickUp** | Create tasks, attach release context, and link campaign work to your task board |
| **Notion** | Read pages, append entries, and sync release notes or campaign briefs |
| **Slack** | Aria-on-Slack is in beta: chat with Aria in Slack and send strategy reports or release updates to channels |
...
Aria reads the release plan from Patchline, turns each open campaign
step into a ClickUp task, and keeps the project context attached.
...
underlying third-party service may have its own usage limits, and Aria
