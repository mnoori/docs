---
title: "Install the Patchline MCP server"
sidebarTitle: "Install in your AI tool"
description: "Step-by-step install for the Patchline product MCP server in Cursor, Codex, Claude Desktop, Claude Code, and VS Code. One config snippet or one command per client. First tool call opens browser-based OAuth — your credentials never touch the AI client."
icon: "download"
keywords:
