...
- Use `analyze_url` if they shared a URL — gets you the metadata
  without importing.
- Recommend they [import or upload](/catalog/import) the track. Import
  gives metadata-backed catalog tools; upload unlocks audio-backed
  sonic analysis and captions.
