...
sidebarTitle: "Upload"
description: "Upload MP3, WAV, or FLAC files directly to your Patchline catalog. Auto-extracts ID3 metadata, runs sonic analysis, and stores the master securely. Best for unreleased work or when you want the master in Patchline."
icon: "upload"
keywords:
...
Patchline stores it securely, extracts ID3 metadata, queues
...
| AI-readable caption | Generated automatically after upload |
