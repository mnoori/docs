...
sidebarTitle: "Upload"
description: "Upload MP3, WAV, or FLAC files directly to your Patchline catalog. Aria captions the track for AI discovery the moment the upload finishes. Best for unreleased work or your masters."
icon: "upload"
keywords:
...
schema:
  - "@context": "https://schema.org"
    ...
    "description": "Add unreleased or master audio to your Patchline catalog. Aria captions the track on upload."
    "totalTime": "PT3M"
---
...
Patchline stores it securely, queues
...
When the upload finishes, Aria starts generating the [AI caption](/catalog/sonic-analysis) for the track so it becomes discoverable across AI tools. You set the title, artist, and other metadata yourself in the track detail panel — Patchline does not extract ID3 tags from your file.
...
- Files are stored in encrypted, access-controlled cloud storage with
  version history.
- Only authorized users in your workspace can access playback or
  download links.
...
<AccordionGroup>
  ...
  <Accordion title="What metadata does Patchline pull from my file?">
    None. Patchline does not read embedded file tags. You set the
    title, artist, ISRC, and other fields manually in the track detail
    panel after upload.
  </Accordion>
