...
sidebarTitle: "Search"
description: "Search across your Patchline catalog by title, artist, ISRC, mood, genre, and natural-language description. Aria-powered semantic search across your AI-captioned tracks."
...
search by free-text query, mood, genre, ISRC, or natural-language description
...
Aria: 47 tracks total. Showing first 10:
  [paginated list with title, artist, AI caption snippet, last activity]
