...
description: "Music industry + Patchline-specific terminology. ISRC, ISWC, DSP, MCP, sonic features, smart link, project anchor, fan graph, and the rest."
icon: "book"
keywords:
  - patchline glossary
...
title, artist, ISRC, mood, genre, BPM, key, and similarity signals.
