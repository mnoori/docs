...
description: "One tab for everything you ship outside Patchline — pitch links, drop links, asset shares, media kits, briefings. Create, send, and track public-facing surfaces in one place."
icon: "rocket"
keywords:
  - launchpad
  - pitch links
