...
<CardGroup cols={2}>
  ...
  <Card title="AI agents" icon="robot">
    Patchline ships first-class agent surfaces: 18-tool MCP server, Claude
...
<CardGroup cols={3}>
  ...
  <Card title="Discover artists" icon="binoculars" href="/artists/scout">
    ...
    your genre using Soundcharts data.
  </Card>
</CardGroup>
...
- **Streaming numbers come from real APIs** (Soundcharts, Spotify Web API,
  Apple), not training data.
- **Sonic analysis is real audio analysis** — Cynite + Patchline's own RIP
  pipeline — not LLM-vibes-based-on-the-title.
