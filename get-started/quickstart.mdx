...
Profiles → catalog → audience → Aria → release plan → public
surfaces → repeat.

Everything else in Patchline — release planning, playlist matching,
pitch generation, storefront, contracts — extends this same pattern.
